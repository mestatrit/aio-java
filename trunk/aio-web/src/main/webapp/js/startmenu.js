...
window.start_menu = function() {
	...
	this.fill_div = function() {
		...
		_html.append('<div id="menu_start_r1" class="r_start_menu_normal" onclick="dt.add_window(\'9001\', \'help\', \'控制面板\', \'\', event);" onmouseover=\"startmenu.start_menu_mouse_over(this);\" onmouseout=\"startmenu.start_menu_mouse_out(this);\" >');
		_html.append('<img src="./images/menu_start_controlpannel.png"/>');
		_html.append("</div>");
		_html.append('<div class="r2_space"></div>');
		_html.append('<div id="menu_start_r2" class="r_start_menu_normal" onclick="dt.add_window(\'9002\', \'help\', \'工具\', \'\', event);" onmouseover=\"startmenu.start_menu_mouse_over(this);\" onmouseout=\"startmenu.start_menu_mouse_out(this);\" >');
		_html.append('<img src="./images/menu_start_tool.png"/>');
		_html.append("</div>");
		_html.append('<div class="r3_space"></div>');
		_html.append('<div id="menu_start_r3" class="r_start_menu_normal" onclick="dt.add_window(\'9003\', \'help\', \'帮助\', \'\', event);" onmouseover=\"startmenu.start_menu_mouse_over(this);\" onmouseout=\"startmenu.start_menu_mouse_out(this);\" >');
		...
		_html.append('<div id="btn_quit" class="btn_quit_normal" onclick="window.location.href=\'' + webapp_contextPath + '/logout.do\'" onmousemove="startmenu.btn_quit_onmouseover();" onmouseout="startmenu.btn_quit_onmouseout();"></div>');
		_html.append("</div>");
		_html.append("</div>");
