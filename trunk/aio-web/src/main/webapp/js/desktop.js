...
window.desktop = function() {
	...
	this.init_window = function() {
		...
		var windowHeight = screenHeight - 39 - 25;
		objplatform.setAttribute("style", "height:" + windowHeight + ";");
	...
	this.fill_content = function() {
		...
		_html.append("</span>");
		_html.append("</div>");
		_html.append("<div id=\"window_secondLevelDiv_" + this.currentid + "\" class=\"window_secondLevelDivClass2\" style=\"height:" + windowHeight + "px;\">");
	...
	this.change_current_window_height = function() {
		for(var i=0; i< this.windows.length; i++) {
			var windowid = this.windows[i];
			var is_visibility = document.getElementById("window_platform" + windowid).style.visibility;
			var o1 = document.getElementById("window_platform" + windowid);
			var o2 = document.getElementById("window_secondLevelDiv_" + windowid);
			if(is_visibility == 'visible') {
				var screenHeight = getWindowHeight();
				var windowHeight = screenHeight - 39 - 25;
				//o1.setAttribute("style", "width:100%; min-width:1024px; margin:0; position:absolute; top:0; left:0; height:" + windowHeight + "px;");
				//o2.setAttribute("style", "width:100%; margin:0 auto 0 auto; background:#ffffff; overflow:hidden; height:" + windowHeight + "px;");
				o1.style.height = windowHeight + 25 + "px";
				o2.style.height = windowHeight + "px";
			}
		}
	};
