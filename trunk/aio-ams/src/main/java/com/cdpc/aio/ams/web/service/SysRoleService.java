...
public class SysRoleService implements BaseService {
	 ...
	 * @throws AppException
	 */
	public void save(TblSysSysrol tblSysSysrol, List<TblSysRolfun> rolefuns) throws AppException {
		log.debug("-----------------Service-SysRoleService------------------------");
	 ...
	 * @throws AppException
	 */
	public void update(TblSysSysrol tblSysSysrol, List<TblSysRolfun> rolefuns) throws AppException {
		log.debug("-----------------Service-SysRoleService------------------------");
	 ...
	 * @throws AppException
	 */
	public void deleteSysRoleByid(String id) throws AppException {
		log.debug("-----------------Service-SysRoleService------------------------");
		...
		if(StringUtils.isEmpty(id)) { 
			...
			try {
				tblSysSysrolDAO.bulkUpdate("delete TblSysSysrol t where t.srId=" + id);
				tblSysRolfunDAO.bulkUpdate("delete TblSysRolfun t where t.rfRoleId='" + roleid + "'");
			} catch(Exception e) {
				log.error(e.getMessage());
				e.printStackTrace();
				throw new AppException("删除角色" + id + "出错");
			}
		}
	}
