...
<body class="main_body">
	<div class="main">
		...
		<div class=content>
			...
			<table width="100%" cellspacing="0" cellpadding="0" class="insert_table">
				<tbody>
					<tr>
						<th width="35%">功能代码</th>
				...
				<tfoot>
					<tr>
						<td colspan="2">
							<input type="button" name="button" value="保存 " onclick="if(jQuery('#f9904-f-3').validationEngine('validate')){save('');};" style="cursor:pointer;" />
