		...
		<div class="outer">
			...
			<div class="box_table">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th>功能代码</th>
							<td width="33%">${f9904OutObject.tblSysSysfun.sfFunctionId }</td>
							<th width="17%">功能名称</th>
							<td width="34%">${f9904OutObject.tblSysSysfun.sfFunctionName }</td>
						</tr>
						<tr>
							<th>上级功能</th>
							<td width="33%">${f9904OutObject.tblSysSysfun.sfParentId }</td>
							<th width="17%">功能链接</th>
							<td width="34%">${f9904OutObject.tblSysSysfun.sfTargetUrl }</td>
						</tr>
						<tr>
							<th>按钮链接</th>
							<td width="33%">${f9904OutObject.tblSysSysfun.sfBtnUrl }</td>
							<th width="17%">显示序号</th>
							<td width="34%">${f9904OutObject.tblSysSysfun.sfSortFlag }</td>
						</tr>
						<tr>
							<th>功能描述</th>
							<td width="33%">${f9904OutObject.tblSysSysfun.sfDescription }</td>
							<th width="17%">是否导航菜单</th>
							<td width="34%"><j:PageTranslate table="tbl_sys_sysfun" column="SF_MENU_FLAG" initValue="${f9904OutObject.tblSysSysfun.sfMenuFlag }" /></td>
						</tr>
						<tr>
							<th>是否页面按钮</th>
							<td width="33%"><j:PageTranslate table="tbl_sys_sysfun" column="SF_BTN_FLAG" initValue="${f9904OutObject.tblSysSysfun.sfBtnFlag }" /></td>
							<th width="17%">支持快捷执行</th>
							<td width="34%"><j:PageTranslate table="tbl_sys_sysfun" column="SF_EXECUTBALE" initValue="${f9904OutObject.tblSysSysfun.sfExecutbale }" /></td>
						</tr>
					</table>
