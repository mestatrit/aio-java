...
<script type="text/javascript" src="js/pages/f9906-j-5.js"></script>
...
<body class="main_body">
	<div class="main">
		...
		<tbody>
			...
			<tr>
				<th>用户角色</th>
				<td><j:PageSelectAnywhere dataService="sysRoleService" labelColumn="srRoleName" valueColumn="srRoleId" initValue="${f9906OutObject.userRole }" notselect="yes" /></td>
			</tr>
			<tr>
				<th>上次登录IP</th>
				<td>${f9906OutObject.tblSysUsrinf.uiLstIpAddress }</td>
			</tr>
			<tr>
				<th>上次登录时间</th>
				<td>${f9906OutObject.tblSysUsrinf.uiLstUserLoginTime }</td>
			</tr>
			<tr>
				<th>上次更新用户ID</th>
				<td>${f9906OutObject.tblSysUsrinf.uiLstModiUserId }</td>
			</tr>
			<tr>
				<th>上次更新时间</th>
				<td>${f9906OutObject.tblSysUsrinf.uiLstModiDate }</td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
