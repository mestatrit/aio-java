...
<body>
	<div class="content">
		...
		<div class="outer">
			...
			<div class="box_form">
				<form id="f9907-f-7" action="f9907-s-8.do" method="post" class="niceform">
					<input type="hidden" id="ovId" name="ovId" value="${f9907OutObject.tblSysOptval.ovId }" />
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th>选项表名</th>
							<td width="33%"><input type="text" id="ovTblName" name="ovTblName" class="validate[required,minSize[1],maxSize[100]]" size="50" value="${f9907OutObject.tblSysOptval.ovTblName }" /> <span><font color="red">*</font></span></td>
							<th width="17%">选项表名</th>
							<td width="34%"><input type="text" id="ovColName" name="ovColName" class="validate[required,minSize[1],maxSize[100]]" size="50" value="${f9907OutObject.tblSysOptval.ovColName }" /> <span><font color="red">*</font></span></td>
						</tr>
						<tr>
							<th>选项标签</th>
							<td width="33%"><input type="text" id="ovOptLabel" name="ovOptLabel" class="validate[required,minSize[1],maxSize[100]]" size="50" value="${f9907OutObject.tblSysOptval.ovOptLabel }" /> <span><font color="red">*</font></span></td>
							<th width="17%">选项值</th>
							<td width="34%"><input type="text" id="ovOptValue" name="ovOptValue" class="validate[required,minSize[1],maxSize[100]]" size="50" value="${f9907OutObject.tblSysOptval.ovOptValue }" /> <span><font color="red">*</font></span></td>
						</tr>
					</table>
					<div class="button_mun">
						<ul>
							<li><a href="##" onclick="if(jQuery('#f9907-f-7').validationEngine('validate')){edit('<%=basePath%>');};"><span>提交修改</span></a></li>
