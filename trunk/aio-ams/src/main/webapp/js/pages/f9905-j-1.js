function insert(baseUrl) {
	window.location.href = "f9905-s-3.do";
}
...
function detail(baseUrl) {
	...
	if(count == 1) {
		var queryForm = document.getElementById("f9905-f-1");
		queryForm.action = "f9905-s-5.do";
		queryForm.submit();
	}
}
