function insert(baseUrl) {
	window.location.href = "f9907-s-3.do";
}
...
function detail(baseUrl) {
	...
	if(count == 1) {
		var queryForm = document.getElementById("f9907-f-1");
		queryForm.action = "f9907-s-5.do";
		queryForm.submit();
	}
}
